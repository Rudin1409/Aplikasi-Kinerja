    ...
    <div class="flex justify-between items-end">
        ...
        <div>
            ...
            <div id="triwulan-buttons" class="flex rounded-md shadow-sm">
                <button data-tw="1" data-text="Kinerja Triwulan 1 (Januari - Maret 2025)" class="tw-button active px-4 py-2 rounded-l-md text-sm font-semibold z-10
                              bg-purple-600 text-white border border-purple-700">
                    TW 1
                </button>
                <button data-tw="2" data-text="Kinerja Triwulan 2 (April - Juni 2025)" class="tw-button inactive px-4 py-2 text-sm font-semibold -ml-px
                              bg-white text-gray-700 border border-gray-300 
                              hover:bg-gray-100">
                    TW 2
                </button>
                <button data-tw="3" data-text="Kinerja Triwulan 3 (Juli - September 2025)" class="tw-button inactive px-4 py-2 text-sm font-semibold -ml-px
                              bg-white text-gray-700 border border-gray-300 
                              hover:bg-gray-100">
                    TW 3
                </button>
                <button data-tw="4" data-text="Kinerja Triwulan 4 (Oktober - Desember 2025)" class="tw-button inactive px-4 py-2 rounded-r-md text-sm font-semibold -ml-px
                              bg-white text-gray-700 border border-gray-300 
                              hover:bg-gray-100">
                    TW 4
                </button>
    ...
    <?php foreach ($iku_data as $iku): ?>
        <div class="bg-white p-5 rounded-lg shadow-md transition duration-300 hover:shadow-xl">
            ...
            <p class="text-xs font-bold text-purple-600 uppercase mb-1">
                <?= isset($iku['sasaran']) ? $iku['sasaran'] : '-' ?></p>
            <p class="text-sm font-medium text-gray-600 mb-3 h-10 overflow-hidden text-ellipsis"><?= $iku['nama'] ?></p>
            <div class="mb-3">
