...
<head>
    ...
    <style>
        ...
        body.sidebar-mini #main-content { margin-left: 5rem; }
        body.sidebar-mini #logo-text,
        body.sidebar-mini .menu-text { opacity: 0; width: 0; visibility: hidden; }
        body.sidebar-mini #sidebar nav a { justify-content: center; padding-left: 0; padding-right: 0; }
        body.sidebar-mini #sidebar .menu-group-title { text-align: center; }
        body.sidebar-mini #sidebar .menu-group-title span { display: none; }
        body.sidebar-mini #sidebar .menu-group-title::after { content: '...'; font-weight: 900; }
        body.sidebar-mini #sidebar-toggle ion-icon { transform: rotate(180deg); }
        body.sidebar-mini #sidebar nav ul li { position: relative; }
        body.sidebar-mini .menu-text {
            position: absolute; left: 100%; top: 50%; transform: translateY(-50%);
            margin-left: 0.75rem; background-color: #111827; color: white;
            padding: 0.5rem 1rem; border-radius: 0.375rem; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);
            opacity: 0; visibility: hidden; transition: opacity 0.2s ease, visibility 0.2s ease;
            white-space: nowrap; z-index: 50;
        }
        body.sidebar-mini nav ul li a:hover .menu-text { opacity: 1; visibility: visible; }
    ...
    <aside id="sidebar" class="w-64 h-screen fixed left-0 top-0 z-40 bg-gray-900 text-gray-300 flex flex-col shadow-lg">
        ...
        <div class="flex items-center justify-between h-20 shadow-md bg-gray-900 px-4 flex-shrink-0">
            <a href="<?= base_url('admin/dashboard') ?>" class="flex items-center overflow-hidden">
                ...
                <span id="logo-text" class="text-xl font-bold text-white ml-2 transition-opacity duration-300 whitespace-nowrap">
                    APKP POLSRI
                </span>
            </a>
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            ...
            <ul>
                ...
                ?>
                <li>
                    <a href="<?= $dashboard_url ?>" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= $dashboard_active_class ?>">
                ...
                <?php if ($role == 'admin'): ?>
                <li>
                    <a href="#" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= ($page == 'input') ? 'bg-purple-600 text-white' : '' ?>">
                ...
                <?php endif; ?>
                <li>
                    <a href="<?= base_url('admin/laporan') ?>" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= ($page == 'laporan') ? 'bg-purple-600 text-white' : '' ?>">
            ...
            <ul>
                <?php if ($role == 'admin'): ?>
                <li>
                    <a href="<?= base_url('admin/user') ?>" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= ($page == 'user') ? 'bg-purple-600 text-white' : '' ?>">
                ...
                <li>
                    <a href="<?= base_url('admin/jurusan-capaian') ?>" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= ($page == 'jurusan') ? 'bg-purple-600 text-white' : '' ?>">
                        <ion-icon name="business-outline" class="text-lg flex-shrink-0"></ion-icon>
                        <span class="menu-text">Jurusan</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('admin/prodi') ?>" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= ($page == 'prodi') ? 'bg-purple-600 text-white' : '' ?>">
                ...
                <li>
                    <a href="<?= base_url('admin/iku') ?>" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= ($page == 'iku' && strpos(current_url(), 'iku-prodi/') === false && strpos(current_url(), 'iku-detail/') === false) ? 'bg-purple-600 text-white' : '' ?>">
                ...
                <?php if ($role == 'admin'): ?>
                <li>
                    <a href="<?= base_url('admin/akun') ?>" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= ($page == 'akun') ? 'bg-purple-600 text-white' : '' ?>">
            ...
            <ul>
                <li>
                    <a href="<?= base_url('admin/panduan') ?>" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= ($page == 'panduan') ? 'bg-purple-600 text-white' : '' ?>">
            ...
            <ul>
                <li>
                    <a href="<?= base_url('admin/pengaturan') ?>" class="flex items-center space-x-3 block py-3 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white <?= ($page == 'pengaturan') ? 'bg-purple-600 text-white' : '' ?>">
    ...
    // 3. Jika tetap belum ada nama gunakan default "User"
        ...
        ?>
                ...
                <div id="user-menu-dropdown" 
                    ...
                    <a href="<?= base_url('admin/pengaturan') ?>" class="flex items-center space-x-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <ion-icon name="settings-outline" class="text-lg"></ion-icon>
                        <span>Pengaturan</span>
                    </a>
                    <a href="<?= base_url('logout') ?>" class="flex items-center space-x-2 px-4 py-2 text-sm text-red-600 hover:bg-gray-100">
